    ...
    return (
        <div className='min-h-screen bg-gradient-to-br from-gray-900 via-gray-900/95 to-gray-900/90 text-white px-4 sm:px-[5%] py-6 md:py-10 relative z-0 '>
            ...
            <div className='text-center mb-8 md:mb-12 space-y-4 group relative'>
                ...
                <h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-emerald-400 via-cyan-300 to-emarald-400 bg-clip-text text-transparent animate-gradient-x loading-tight'>
                    Crypto <br />
                ...
                <p className='text-gray-300/80 max-w-xl mx-auto text-sm sm:text-base md:text-lg loading-relaxed
            mt-4'>
                    Track real-time crypto market metrics with advanced analytics and
                    <span className='bg-gradient-to-r from-emarald-400/80 to-cyan-400/80 bg-clip-text text-transparent
                mx-2'>
            ...
            {isCurrencyDropdownOpen && (
                <div className='relative bg-gray-800/95 backdrop-blur-xl rounded-lg border border-emerald-500/20
                shadow-2xl z-50'>
                    {["usd","eur", "inr"].map((code) => (
                        <div key={code} className='px-4 py-3 hover-bg-emerald-600/30 transition-colors cursor-pointer flex items-center gap-2'
